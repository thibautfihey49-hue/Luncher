    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            findViewById<View>(R.id.btnPhone)?.setOnClickListener {
                try { startActivity(Intent(this, PhoneAppActivity::class.java)) } catch (_: Exception) {}
            }
            findViewById<View>(R.id.btnSms)?.setOnClickListener {
                try { startActivity(Intent(this, SmsAppActivity::class.java)) } catch (_: Exception) {}
            }
            findViewById<View>(R.id.btnFiles)?.setOnClickListener {
                try { startActivity(Intent(this, FileManagerActivity::class.java)) } catch (_: Exception) {}
            }
            ...
            Thread {
                try {
                    ...
                    runOnUiThread { allApps = apps; adapter.update(apps) }
                } catch (_: Exception) {}
            }.start()
        } catch (e: Exception) {
