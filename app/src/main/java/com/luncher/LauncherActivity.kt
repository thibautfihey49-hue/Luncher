...
class LauncherActivity : AppCompatActivity() {
    ...
    private lateinit var search_bar_container: LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        search_bar_container = findViewById(R.id.search_bar_container)
    ...
    private fun setupDrawerGestures() {
        ...
        search_bar_container.setOnTouchListener { _, event ->
            when (event.action) {
                MotionEvent.ACTION_DOWN -> {
                    startY = event.rawY
                    drawerOffset = 0f
